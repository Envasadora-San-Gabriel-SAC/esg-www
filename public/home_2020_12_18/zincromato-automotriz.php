...
<html lang="en">
    <head>
        ...
        <title>ESG - Zincromato Automotriz</title>
            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Esmalte Anticorrosivo / <span>Zincromato Automotriz</span>
                    </h4>
                </div>
                ...
                <div class="col-md-6 img">
                    <img src="<?=base_url();?>public/img/anticorrosivo-automotriz.jpg" alt="" class="img-responsive pull-right">
                </div>
