            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / latex y bases / <span>satinado</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-azul">
                    <h2>ficha tecnica</h2>
                    <p>Para uso de interiores y exteriores. Excelente acabado y fina textura. Alta lavabilidad y apariencia satinado.</p>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/satinado.jpg" alt="" class="img-responsive pull-right">
                </div>
