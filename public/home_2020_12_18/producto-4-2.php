    ...
    <body>
        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p>Para acabados traslúcidos y brillantes: es un polímero del tipo poliéster insaturado de alto brillo y transparente. Se utiliza principalmente para acabados traslucidos y también del tipo gel-coat para moldes.</p>
                    </div>
                </div>
            ...
            <section class="container producto">
                ...
                <div class="col-md-6 info info-verde">
                    <h2>ficha tecnica</h2>
                    <p>Producto elaborado con resina metacrilada de alta calidad resistente a los rayos UV que garantiza un excelente brillo y acabado de calidad.</p>
                ...
                <div class="col-md-6 img">
                    <img src="<?=base_url();?>public/img/productos/tr-600.jpg" alt="" class="img-responsive pull-right">
                </div>
