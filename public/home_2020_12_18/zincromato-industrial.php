...
<html lang="en">
    <head>
        ...
        <title>ESG - Zincromato Industrial</title>
            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Esmalte Anticorrosivo / <span>Zincromato Industrial</span>
                    </h4>
                </div>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/anticorrosivo-industrial.jpg" alt="" class="img-responsive pull-right">
                </div>
