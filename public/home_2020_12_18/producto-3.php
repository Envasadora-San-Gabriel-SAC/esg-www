        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <h2 class="text-center">
                    RESINAS Y REVESTIMIENTO<br> DE TANQUES Y OTROS<br>
                    <img src="<?=base_url();?>public/img/icon-prod3.svg" width="50" class="img-center" >
                </h2>

                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p>En nuestra preocupación constante por solucionar las necesidades de nuestros clientes hemos incorporado el servicio de pintado, utilizando máquinas de última tecnología, personal altamente calificado y garantía de servicio post venta. El proceso de pintado ESG nos garantiza: Menor tiempo de ejecución, menores costos y mayor calidad.</p>
                        <p>Nosotros ofrecemos la alternativa ideal, revestimos tu tanque con fibra de vidrio en el lugar, sin tener que moverlo y con un mínimo de tiempo de paralización de tu venta.</p>
                        <p>Aplicamos tu tanque un revestimiento de fibra de vidrio resistente al etanol, de un espesor 0.7 cm o mayor, de acuerdo a la necesidad.</p>
                    </div>
                </div>

                <div class="col-md-12 z9">
                    <div class="img">
                        <img src="public/img/s3.jpg" alt="" class="img-responsive img-center">
                    </div>
                </div>
