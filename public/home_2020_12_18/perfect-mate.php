            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Latex y Bases / <span>Perfect Mate</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-verde">
                    <h2>ficha tecnica</h2>
                    <p>Látex de acabado mate. Para uso de interiores y exteriores con aditivos UV para mayor resistencia. Alta lavabilidad.</p>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/perfect-mate.jpg" alt="" class="img-responsive pull-right">
                </div>
