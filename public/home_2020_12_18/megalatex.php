            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Latex y Bases / <span>Megalatex</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-rojo">
                    <h2>ficha tecnica</h2>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/megalatex.jpg" alt="" class="img-responsive pull-right">
                </div>
