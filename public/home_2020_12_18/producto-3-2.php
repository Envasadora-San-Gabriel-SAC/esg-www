        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <h2 class="text-center">
                    REVESTIMIENTO DE TANQUES<br>
                    <img src="<?=base_url();?>public/img/icon-s3-1.svg" width="50" class="img-center" >
                </h2>
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        ...
                        <p>Aplicamos a tu tanque un revestimiento de fibra de vidrio resistente al etanol, de un espesor 0.7 cm o mayor, de acuerdo a la necesidad.</p>
                    </div>
                </div>

                <div class="col-md-12 z9">
                    <div class="img">
                        <img src="public/img/revestimiento-de-tanques.jpg" alt="" class="img-responsive img-center">
                    </div>
                </div>

                <div class="col-md-12 group-links">
                    <p class="text-center">
                        <a href="resina-ug-500" class="link" title="Resina UG-500">Ir a Resina UG-500</a> | <a href="resina-tr-600" class="link" title="Resina TR-600">Ir a Resina TR-600</a>
                    </p>
                </div>
