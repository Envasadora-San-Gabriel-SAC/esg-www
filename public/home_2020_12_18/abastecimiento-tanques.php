        ...
        <main>
            ...
            <section class="container nuestros-clientes">
                ...
                <h2 class="text-center">
                    ABASTECIMIENTO A TANQUES<br>
                    <img src="<?=base_url();?>public/img/icon-descubreclark.svg" width="50" class="img-center" >
                </h2>
				<P class="text-center">Efectuamos el abastecimiento a clientes en sus locales o en un lugar de la obra y directamente a tanques estacionarios de 5000 o 4000 galones de capacidad, mediantes cisternas madrinas de 3000 galones.Esta operación se realiza en Lima, Callao y provincias.</P>
                <br>
				<div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">					
						<img src="<?=base_url();?>public/img/s7.jpeg" class="img-responsive" alt="...">
					</div>
                </div>
				<br>
