        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p>Uso general, es un polímero tipo poliéster insaturado, que se utiliza principalmente como material de refuerzo en sanitarios, pisos para ducha, acabados automotrices, maniquíes, separadores, calaminas y otros de uso general.</p>
                    </div>
                </div>
            ...
            <section class="container producto">
                ...
                <div class="col-md-6 img">
                    <img src="<?=base_url();?>public/img/productos/ug-500.jpg" alt="" class="img-responsive pull-right">
                </div>
