        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <h2 class="text-center">
                    MONOMERO ESTIRENOS<br>
                    <img src="<?=base_url();?>public/img/icon-prod4.svg" width="50" class="img-center" >
                </h2>
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p>Características</p>
                        <ul class="text-left">
                            <li>Es un producto químico muy reactivo, inflamable y tóxico</li>
                            <li>No es soluble en agua</li>
                            <li>Se polimeriza con el calor y la luz solar</li>
                            <li>Su Estabilidad en el almacenaje es de 6 meses y debe ser  almacenado bajo sombra, en cilindros cerrados o envases que no sean transparentes</li>
                            <li>Número de seguridad (de las Naciones Unidas) NU 2055</li>
                        </ul>
                        <p>Usos</p>
                            <ul class="text-left">
                                <li>Se usa como diluyente de la resina Polyclark UG 500 y Polyclark TR 600 en una proporción del 30% en peso</li>
                                <li>Se debe usar EPP (Equipo de Protección Personal) cuando se manipula el producto</li>
                                <li>No se debe almacenar cerca de oxidantes fuertes, como compuestos de cloro o catalizadores como el Peróxido de MEK.</li>
                            </ul>
                        </ul>
                    </div>
                </div>
