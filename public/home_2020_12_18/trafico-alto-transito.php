            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Pintura tráfico/ <span>tráfico alto transito</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-naranja">
                    <h2>ficha tecnica</h2>
                    <p>Producto elaborado de resinas alquídicas, caucho clorado y pigmentos especiales que en conjunto dan un producto de gran resistencia y abrasión al desgaste. Utilizado para tránsito vehicular y/o peatonal</p>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/trafico-alto-transito.jpg" alt="" class="img-responsive pull-right">
                </div>
