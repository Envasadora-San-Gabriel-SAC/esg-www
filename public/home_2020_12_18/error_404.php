                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <nav id="navbar" class="navbar collapse navbar-collapse text-center">
                            <ul class="nav">
                                ...
                                <li><a class="active" href="<?=base_url();?>descubre-clark">descubre clark</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <section class="container">
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p class="text-center">
                            <img src="public/img/error404.svg" width="250" alt="" class="img-responsive img-center">
                        </p>
                        <h3>Pagina no encontrada.</h3>
                        <p><a href="<?=base_url();?>" class="back">Regresar a portada</a></p>
                    </div>
                </div>
