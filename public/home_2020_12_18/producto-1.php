        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <h2 class="text-center">
                    DISTRIBUCION Y COMERCIALIZACION<br> DE COMBUSTIBLES<br>
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        ...
                        <p>Abastecemos directamente a sus máquinas o equipos mediante cisternas surtidoras de 700 a 1200 galones de capacidad, las cuales tienen incorporadas surtidores de despacho con contómetro, bomba, mangueras y filtro. Esta operación se realiza en Lima, Callao y provincias.</p>
</p>
                    </div>
                </div>
                ...
                <div class="col-md-12 z9">
                    <div class="img">
                        <img src="public/img/img-prod1.jpg" alt="" class="img-responsive img-center">
                    </div>
                </div>

                <div class="col-md-12 group-links">
                    <p class="text-center">
                        <a href="tanques-estacionarios" class="link" title="Abastecimiento de Tanques Estacionarios">Ir a Abastecimiento de Tanques Estacionarios</a> | <a href="maquinaria-pesada" class="link" title="Abastecimiento a Maquinaria Pesada">Ir a Abastecimiento a Maquinaria Pesada</a>
                    </p>
                </div>
