            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / Esmaltes oleo mate/ <span>oleo mate</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-naranja">
                    <h2>ficha tecnica</h2>
                    <p>Utilizado para pintar superficies de cemento, concreto, yeso, madera y metal con acabado mate. Resistente y de alta protección.</p>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/oleo-mate.jpg" alt="" class="img-responsive pull-right">
                </div>
