        ...
        <main>
            ...
            <section class="container quienes-somos">
                ...
                <h2 class="text-center">
                    SOLIDEZ, CONFIANZA<br>Y RESPALDO<br>
                    <img src="<?=base_url();?>public/img/icon-businness.svg" width="50" class="img-center" >
                </h2>

                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <h3>quienes somos</h3>
                        <p>ESG - Envasadora San Gabriel, es una empresa con negocios diversificados y clasificada entre las empresas top en la cámara de comercio de Lima. Iniciamos nuestras operaciones en el año 1996. Durante este tiempo nos hemos expandido abarcando negocios como:</p>
                        <ul class="list-unstyled">
                            <li>Distribución y comercialización de hidrocarburos.</li>
                            <li>Fabricación de pinturas en general y servicio de pintado.</li>
                            <li>Fabricación de resinas, piezas de fibra de vidrio y revestimiento de tanques.</li>
                            <li>Comercialización de solventes y productos químicos.</li>
                        </ul>
                    </div>
                </div>

                <div class="col-md-10 col-md-offset-1 z9">
                    <div class="img">
                        <img src="public/img/mesa-directorio.jpg" alt="" class="img-responsive img-center">
                    </div>
                </div>
            ...
            <section class="mision-vision">
                <div class="container">
                    <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                        ...
                        <p>Ser líderes en el mercado nacional brindando productos y servicios de gran calidad, respaldados en la continua innovación tecnológica, satisfaciendo las necesidades de nuestros clientes por encima de sus expectativas.</p>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12 text-center">
                        <h3>NUESTRA MISION</h3>
                        <p>Construir una relación duradera con nuestros clientes, satisfaciendo sus necesidades con productos y servicios de alta calidad, utilizando materia prima selecta, tecnología avanzada, colaboradores motivados y de alto desempeño. Estamos comprometidos con el mejoramiento continuo de los procesos, el cuidado y protección del medio ambiente, con el fin de lograr la diferenciación y el desarrollo socioeconómico sostenible de nuestra organización.</p>
                    </div>
                    <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
                        <div class="img">
                            <img src="public/img/tema-ambiental.jpg" alt="" class="img-responsive img-center">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="nuestros-valores">
                <div class="container">
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 text-center">
                        ...
                        <p>Somos una empresa comprometida con el cuidado del medio ambiente que integra en sus procesos de producción, distribución y comercialización altos estándares de calidad.</p>
                    </div>
                </div>
            </section>
