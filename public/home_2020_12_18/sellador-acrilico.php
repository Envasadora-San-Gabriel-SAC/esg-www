            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / bases / <span>sellador acrílico</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-azul">
                    <h2>ficha tecnica</h2>
                    <p>Producto utilizado para sellar y mejorar la adherencia en superficies como yeso, asbesto, paredes con pinturas antiguas, paredes con pasta mural o pintadas con temple.</p>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #EEBB04 !important;">SELLADOR</th>
                                    <th style="background-color: #32B9D9 !important;">SELLADOR</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/sellador-acrilico.jpg" alt="" class="img-responsive pull-right">
                </div>
