            ...
            <section class="container quienes-somos">
                ...
                <div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">
                        <p>Distribuimos y comercializamos productos quimicos para la industria con altos estandares de calidad, con la garantia y respaldo de ESG</p>
                    </div>
                </div>

                <div class="col-md-12 group-links">
                    <p class="text-center">
                        <a href="monomero-estireno" class="link" title="Monomero Estireno">Ir a Monomero Estireno</a> | <a href="solventes-diluyentes" class="link" title="Solventes Diluyentes">Ir a Solventes Diluyentes</a>
                    </p>
                </div>
