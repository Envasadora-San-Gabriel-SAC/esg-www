            ...
            <section class="container producto">
                ...
                <div class="col-md-12 breancrumb">
                    <h4 class="text-center">
                        Pinturas clark / bases / <span>pasta mural</span>
                    </h4>
                </div>

                <div class="col-md-6 info info-verde">
                    <h2>ficha tecnica</h2>
                    <p>Producto que permite tener superficie de acabado liso, mejora la apariencia de pinturas satinadas y brillantes.</p>
                ...
                <div class="col-md-6 img">
                    <img src="public/img/productos/pasta-mural.jpg" alt="" class="img-responsive pull-right">
                </div>
