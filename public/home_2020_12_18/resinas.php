    ...
    <body>
        ...
        <main>
            ...
            <section class="container nuestros-clientes">
				...
				<h4 class="text-center">RESINA POLYCLARK UG-500</h4>
				<P class="text-center">Es un polímetro tipo poliéster insaturado, que  se utiliza princialmente como material de refuerzo en sanitarios, pisos para ducha, acabados automotrices, maniquies, separados, calaminas y otros de uso general.</P>
                <br>
				<h4 class="text-center">RESINA POLYCLARK TR-600</h4>
				<P class="text-center">Es un polímetro tipo poliéster insaturado de alto brillo y transparente. Se utiliza principalmente para acabados traslucidos, brillantes y tambien del tipo gel-coat para moldes.</p>
                <br>
				<br>
				<div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">					
						<img src="<?=base_url();?>public/img/s3.jpg" class="img-responsive" alt="...">
					</div>
                </div>
				<br>
