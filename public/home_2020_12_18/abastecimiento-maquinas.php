        ...
        <main>
            ...
            <section class="container nuestros-clientes">
                ...
                <h2 class="text-center">
                    ABASTECIMIENTO A MAQUINARIAS<br>
                    <img src="<?=base_url();?>public/img/icon-descubreclark.svg" width="50" class="img-center" >
                </h2>
				<P class="text-center">Abastecemos directamente a sus máquinas o equipos mediante cisternas de 700 a 1500 galones de capacidad, las cuales tienen incorporado surtidores de despacho con contómetro, bomba, mangueras y filtros. Esta operación se realiza en Lima, Callao y provincias.</p>
                <br>
				<br>
				<div class="col-md-8 col-md-offset-2 z99">
                    <div class="info text-center">					
						<img src="<?=base_url();?>public/img/s6.jpeg" class="img-responsive" alt="...">
					</div>
                </div>
				<br>
