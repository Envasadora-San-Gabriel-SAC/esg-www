...
<div class="col-8">
    <form action="" method="POST" role="form">
        ...
        <div class="form-group row mb-2">
            <label for="phone" class="col-sm-2 col-form-label">Teléfono / Móvil</label>
            <div class="col-sm-10">
...
<div class="col-4">
    <div class="card mb-3 p-3" style="border-radius: 10px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
        <div class="mb-3">
