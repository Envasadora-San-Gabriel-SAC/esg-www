...
<style>
    .bg-gradient {
        ...
        background: linear-gradient(to right, #0f8713c9 0%, #7df46d 30%, #e1ffc88a 100%) !important;
    }    
</style>    
@endsection
...
<section class="jarallax bg-gradient pt-5 pb-7 pt-md-7" data-jarallax data-speed="0.25">
    ...
    <div class="jarallax-img" style="background-image: url(images/contact/page-title-bg.jpg);"></div>
  ...
  <section class="container bg-overlay-content pb-5">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 offset-md-1">
            ...
            <h3 class="h6 pb-2">Planta de Produccion</h3>
            <ul class="list-unstyled font-size-sm pb-3">
            <li class="d-flex align-items-top mb-3">
                <i class="fas fa-map-marker-alt font-size-xl text-muted mt-1 mr-2 pr-1"></i>
                <div>Calle La Pampilla 121<br>Ventanilla, Callao<br><a class="cs-fancy-link" href="#map" data-scroll>See on the map</a></div>
            </li>
            <li class="d-flex align-items-center mb-3">
                <i class="far fa-envelope-open font-size-xl text-muted mr-2 pr-1"></i>
                <div>ventas2@esg.com.pe</div>
            </li>
            <li class="d-flex align-items-center mb-3">
                <i class="fas fa-phone-square-alt font-size-xl text-muted mr-2 pr-1"></i>
                <div>(+51) 1 713 1630</div>
            </li>
            </ul>
            <h3 class="h6 pb-2">Oficina Admistrativa</h3>
            <ul class="list-unstyled font-size-sm">
            <li class="d-flex align-items-top mb-3">
                <i class="fas fa-map-marker-alt font-size-xl text-muted mt-1 mr-2 pr-1"></i>
                <div>Av Jose Pardo 601 Of 404,<br>Miraflores, Lima<br></div>
            </li>
            <li class="d-flex align-items-center mb-3"><i class="fe-mail font-size-xl text-muted mr-2 pr-1"></i>
                <div>operaciones@esg.com.pe</div>
            </li>
